...
public class Asteroids implements KeyListener {
	...
	private void handleLifeGain(long score, long scoreIncrease) {
		...
		if(Math.floor(newScore / 10000.0) > Math.floor(score / 10000.0)) {
			if(livesLeft < 3) {
				livesLeft += 1;
			}
		}
	...
	private void drawFPS(Graphics g) {
		...
		g.drawString(text, frameWidth - textWidth - 20, 16);
	...
	private void drawMainMenu(Graphics g) {
		...
		g.drawString(titleText, (frameWidth - textWidth) / 2, (frameHeight / 24) * 4);
		...
		g.drawString(startGameText, (frameWidth - textWidth) / 2 , ((frameHeight - metrics.getHeight()) / 24) * 11);

		//Draw highscore menu Text
		textWidth = metrics.stringWidth(highscoreMenuText);
		g.drawString(highscoreMenuText, (frameWidth - textWidth) / 2, ((frameHeight - metrics.getHeight()) / 24) * 13);

		//Draw exit Text
		textWidth = metrics.stringWidth(exitText);
		g.drawString(exitText, (frameWidth - textWidth) / 2, ((frameHeight - metrics.getHeight()) / 24) * 15);
	...
	private void drawHighscoreMenu(Graphics g) {
		...
		g.fillRect((frameWidth / 3), (frameHeight / 24) * 2, frameWidth / 3, (frameHeight / 24) * 19);
		g.setColor(Color.white);
		g.drawRect((frameWidth / 3), (frameHeight / 24) * 2, frameWidth / 3, (frameHeight / 24) * 19);
	...
	private void drawGameOver(Graphics g) {
		...
		//Draw backdrop
		g.setColor(Color.black);
		g.fillRect((frameWidth / 3), (frameHeight / 24), frameWidth / 3, (frameHeight / 24) * 21);
		g.setColor(Color.white);
		g.drawRect((frameWidth / 3), (frameHeight / 24), frameWidth / 3, (frameHeight / 24) * 21);

		//Draw Dividers
		g.drawLine((frameWidth / 3), (int) ((frameHeight / 24) * 3.5), (frameWidth / 3) * 2, (int) ((frameHeight / 24) * 3.5));
		g.drawLine((frameWidth / 3), (frameHeight / 24) * 20, (frameWidth / 3) * 2, (frameHeight / 24) * 20);
		...
		g.drawString(scoreText, (frameWidth - textWidth) / 2, (frameHeight / 24) * 3);
